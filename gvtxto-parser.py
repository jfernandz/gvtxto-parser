...
@click.command()
@click.option('--prompt/--no-prompt', '-p/ ', default=False,
              help='Enables prompt input mode')
@click.option('--head/--no-head', ' /-H', default=True,
              help='Enables/disables header printing')
